      ...
      <div className="settings-container">
        ...
        <div className="row">
          ...
          <div className="col-lg-2 p-4 ">
            <div className="settings-sidebar-item p-3 settings-active"><i className="fa fa-cog" />Settings</div>
            <div className="settings-sidebar-item p-3 " onClick={() => {
              ...
              newtab.activate()
            }}><i className="fa fa-info-circle" />About</div>
